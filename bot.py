...
async def start(event):
  await event.reply(
"""Etiket Botumuz Suanda Aktif @megruvsohbet
...
""",
    ...
    buttons=(
       [
        ...
        Button.url('iletisim', 'https://t.me/megruv')
    ],
    )
  )
...
async def help(event):
  helptext = "COMMANDS:@all,/cancel. @megruv @all : Tüm Kisileri Etiketler. /cancel : durdur @megruv"
  await event.reply(
    helptext,
    link_preview=False,
    buttons=(
